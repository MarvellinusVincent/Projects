...
def hefty_hogs(player_score, opponent_score):
    ...
    if player_score == 0 and opponent_score == 0:
        ...
        while opponent_score != 0:
            ...
            total = digit_fn(last)(player_score)
            player_score = total
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    # BEGIN PROBLEM 7
        "*** YOUR CODE HERE ***"
        say = say_scores(score0,score1,leader)
    # END PROBLEM 7
...
def hog_pile_strategy(score, opponent_score, threshold=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    final_score = hefty_hogs(score,opponent_score) + score
    if hog_pile(final_score, opponent_score):
        return 0
